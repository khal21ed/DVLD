...
namespace DVLD
{
    public partial class frmManagePeople : Form
    {
        ...
        private bool _TryGetSelectedPersonIdFromGrid(out int personID)
        {
            personID= -1;
        ...
        {
            if (!_TryGetSelectedPersonIdFromGrid(out personID))
            {
                MessageBox.Show(
        ...
        private void _FilterGrid()
        {
            ...
            string filterColumn = columnNames[cmbFilterBy.SelectedIndex];

            dgvPeople.DataSource = clsPerson.getPeopleFilterdBy(filterColumn, tbFilterBy.Text.ToString());
            lblTotalPeople.Text = "# Records: " + dgvPeople.DisplayedRowCount(false).ToString();
        }
